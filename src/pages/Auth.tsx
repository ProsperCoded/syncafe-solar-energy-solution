...
const Auth = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-gradient-to-br from-purple-600 to-blue-500 min-h-screen">
      <div className="bg-white shadow-2xl p-8 rounded-xl w-96">
